    ...
    function (declare, BaseWidget, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented, template, lang, query,
        ...
        return declare([BaseWidget, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
            ...
            _onBtnPrintClicked: function () {
                ...
                let rebateProgram = [];
                let rebateAmount = [];
                let rebateAmountString = [];

                resultsList.forEach(function (rebateObject) {
                    if (!firstName.includes(rebateObject['first_name'])) {
                        firstName.push(rebateObject['first_name']);
                    }
                    if (!lastName.includes(rebateObject['last_name'])) {
                        lastName.push(rebateObject['last_name']);
                    }
                    if (!address.includes(rebateObject['address'])) {
                        address.push(rebateObject['address']);
                    }
                    if (!city.includes(rebateObject['city'])) {
                        city.push(rebateObject['city']);
                    }
                    if (!zipCode.includes(rebateObject['zip'])) {
                        zipCode.push(rebateObject['zip']);
                    }
                    if (!accountNumber.includes(rebateObject['account_number'])) {
                        accountNumber.push(rebateObject['account_number']);
                    }
                    if (!paymentMethod.includes(rebateObject['payment_method'])) {
                        paymentMethod.push(rebateObject['payment_method']);
                    }

                    rebateProgram.push(rebateObject['rebate_program']);
                    let rebateAmountResult = rebateObject['rebate_amount'];
                    let toString = rebateAmountResult.toLocaleString('en-us', {style: 'currency', currency: 'USD'})
                    rebateAmount.push(rebateAmountResult);
                    rebateAmountString.push(toString)
                });

                if (rebateProgram.length < 5) {
                    for (let i = rebateProgram.length; i < 5; i++) {
                        rebateProgram.push('')
                    }
                }
                ...
                let totalAmount = rebateAmount.reduce(getSum);
                totalAmount = totalAmount.toLocaleString('en-us', {style: 'currency', currency: 'USD'})

                if (rebateAmountString.length < 5) {
                    for (let i = rebateAmountString.length; i < 5; i++) {
                        rebateAmountString.push('')
                    }
                }

                let fullName = `${firstName[0]} ${lastName[0]}`;
                let cityPlusState = `${city[0]}, CA`;

                let printData = [
                    {
                        type: "html",
                        data: `<table class="tableizer-table" style="width: 100%; height: 100%; margin: 0 auto;">
<thead>
...
<tr>
<td colspan='8' align='center'>West Valley Water District</td>
</tr>
<tr>
<td  colspan='8' align='center'>Disbursement Voucher</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<tr>
<td>&nbsp;</td>
<td  colspan='4'>${address[0]}</td>
<td>&nbsp;</td>
<td style="font-weight:bold">Date Req'd:</td>
<td>&nbsp;</td>
</tr>
<tr>
<td>&nbsp;</td>
<td  colspan='2'>${cityPlusState}</td>
<td>&nbsp;</td>
<td>${zipCode[0]}</td>
<td>&nbsp;</td>
...
<td colspan='3'>${accountNumber[0]}</td>
...
<tr>
<td style="font-weight:bold">General Ledger #</td>
<td colspan='4'>Rebate 011-5020-594-10-10</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
</tr>
...
<td>${paymentMethod[0]}</td>
<td>-</td>
<td colspan='3'>${rebateProgram[0]}</td>
<td>&nbsp;</td>
<td>${rebateAmountString[0]}</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td colspan='3'>${rebateProgram[1]}</td>
<td>&nbsp;</td>
<td>${rebateAmountString[1]}</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td colspan='3'>${rebateProgram[2]}</td>
<td>&nbsp;</td>
<td>${rebateAmountString[2]}</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td colspan='3'>${rebateProgram[3]}</td>
<td>&nbsp;</td>
<td>${rebateAmountString[3]}</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td colspan='3'>${rebateProgram[4]}</td>
<td>&nbsp;</td>
<td>${rebateAmountString[4]}</td>
</tr>
<tr>
<td>&nbsp;</td>
<td>&nbsp;</td>
